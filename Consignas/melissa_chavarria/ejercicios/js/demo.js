...
function validar_documento(doc) {
  ...
  switch (tipo_doc) {
    case "dni":
      ...
      document.getElementById("doc_seleccionado").innerHTML = 
      "Ud seleccionó DNI";
      break;
    case "cuit":
      console.log("cuit en mayusculas" + tipo_doc.toUpperCase());
      document.getElementById("doc_seleccionado").innerHTML = 
      "Ud seleccionó CUIT";
      break;
    case "pasaporte":
      alert("Ud seleccionó PASAPORTE");
      console.log("PASAPORTE en minusculas" + tipo_doc.toLowerCase());
      document.getElementById("doc_seleccionado").innerHTML = 
      "Ud seleccionó PASAPORTE"
      break;
    default:
